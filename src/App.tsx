    ...
    <div className="bg-[#0a0a0a] text-white font-sans antialiased selection:bg-red-500/30 selection:text-white">
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
          <a href="#hero" onClick={() => scroll("#hero")} className="flex items-center gap-2 sm:gap-3 group">
            <img 
              src="https://res.cloudinary.com/dtc5ancbn/image/upload/v1776262717/gpt-image-1.5-high-fidelity_a_%D0%A1%D0%BE%D0%B7%D0%B4%D0%B0%D0%B9_%D0%BB%D0%BE%D0%B3%D0%BE%D1%82%D0%B8%D0%BF_%D0%B4%D0%BB%D1%8F_%D0%BA_yr2aap.png" 
              alt="Первая Кровь" 
              className="h-10 sm:h-14 w-auto object-contain group-hover:scale-105 transition-transform duration-300"
            />
            <span className="font-aggressive text-base sm:text-lg tracking-wider text-blood-sm whitespace-nowrap">
              <span className="text-white group-hover:text-red-400 transition-colors duration-300">ПЕРВАЯ</span>{" "}
              <span className="text-red-500 group-hover:text-red-400 transition-colors duration-300">КРОВЬ</span>
            </span>
          </a>
      ...
      {/* ══════════ HERO ══════════ */}
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 sm:pt-32 pb-16 sm:pb-20">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto">
          ...
          >
            <img 
              src="https://res.cloudinary.com/dtc5ancbn/image/upload/v1776262717/gpt-image-1.5-high-fidelity_a_%D0%A1%D0%BE%D0%B7%D0%B4%D0%B0%D0%B9_%D0%BB%D0%BE%D0%B3%D0%BE%D1%82%D0%B8%D0%BF_%D0%B4%D0%BB%D1%8F_%D0%BA_yr2aap.png" 
              alt="Первая Кровь" 
              className="h-28 sm:h-48 md:h-60 lg:h-80 w-auto object-contain mx-auto drop-shadow-[0_0_40px_rgba(220,38,38,0.5)]"
            />
          </motion.div>
          ...
          <motion.h1
            ...
            className="font-aggressive text-2xl sm:text-4xl md:text-6xl lg:text-7xl leading-[1.1] mb-4 sm:mb-6 tracking-wider text-blood"
          >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-2xl text-white/60 font-light max-w-2xl mx-auto mb-3 sm:mb-4 leading-relaxed"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base text-white/40 max-w-xl mx-auto mb-8 sm:mb-10"
          >
          ...
          >
            {[
              ...
              <div key={s.label} className="text-center min-w-[70px]">
                ...
                <div className="text-[10px] sm:text-[11px] tracking-wider uppercase text-white/30">{s.label}</div>
              </div>
            ))}
          </motion.div>
          ...
          >
            <button
              onClick={() => scroll("#register")}
              className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-red-600 hover:bg-red-500 text-white font-bold text-sm sm:text-base rounded-xl transition-all duration-300 hover:shadow-xl hover:shadow-red-500/30 pulse-red"
            >
              🎮 Записаться на турнир
            </button>
            <button
              onClick={() => scroll("#about")}
              className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 border border-white/20 hover:border-red-500/50 text-white/80 hover:text-white font-semibold text-sm sm:text-base rounded-xl transition-all duration-300 hover:bg-white/5"
            >
              Подробные правила ↓
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-8 sm:mt-12 inline-flex flex-wrap items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-white/[0.03] border border-white/5 rounded-lg"
          >
            <span className="text-[10px] sm:text-[11px] tracking-[0.15em] uppercase text-white/30">При поддержке:</span>
            <span className="text-xs sm:text-sm font-semibold text-white/60">Молодёжное отделение ЛДПР Алтайского края</span>
          </motion.div>
        </div>
      ...
      {/* ══════════ ABOUT ══════════ */}
      <Section id="about" className="relative py-16 sm:py-28 md:py-36 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            {/* Text side */}
            <div>
              <h2 className="font-orbitron font-bold text-2xl sm:text-3xl md:text-5xl mb-6 sm:mb-8 leading-tight">
                Турнир<br />
      ...
      <Section className="relative py-12 sm:py-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center">
          {[
            ...
            <div key={s.label}>
              <div className="font-orbitron text-2xl sm:text-4xl md:text-5xl font-black text-red-500 mb-2 whitespace-nowrap">
      ...
      {/* ══════════ TOURNAMENT FORMAT ══════════ */}
      <Section id="format" className="relative py-16 sm:py-28 md:py-36 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-red-900/5 via-transparent to-red-900/5" />
        <div className="absolute inset-0 grid-bg opacity-10" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          {/* Section header */}
          <div className="flex items-center gap-3 sm:gap-4 mb-4">
            <span className="text-red-500 font-orbitron font-bold text-sm">02</span>
            <div className="h-px w-8 sm:w-12 bg-red-500/40" />
            <span className="text-[10px] sm:text-[11px] tracking-[0.2em] sm:tracking-[0.3em] uppercase text-white/30">Порядок проведения</span>
          </div>
          <h2 className="font-orbitron font-bold text-2xl sm:text-3xl md:text-5xl mb-4 sm:mb-6">
            Формат <span className="text-red-500">турнира</span>
          </h2>
          <p className="text-white/50 text-base sm:text-lg max-w-2xl mb-10 sm:mb-16">
            Двухэтапный формат: онлайн-квалификация для определения сильнейших и оффлайн-финал в ПК-клубе Барнаула.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            >
              ...
              <div className="relative bg-[#111] border border-white/5 rounded-2xl p-5 sm:p-8 h-full group-hover:border-white/10 transition-colors duration-300">
                {/* Stage number */}
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center">
                    <span className="text-blue-400 font-orbitron font-bold text-base sm:text-lg">1</span>
                  </div>
                  <div>
                    <h3 className="font-orbitron font-bold text-base sm:text-xl text-white">Онлайн-квалификация</h3>
                    <span className="text-blue-400 text-xs tracking-widest uppercase">10–20 мая</span>
                  </div>
                </div>

                <p className="text-white/50 mb-6 leading-relaxed">
                  Квалификационные матчи пройдут в <strong className="text-white/70">онлайн-формате</strong> в Discord-лобби. Команды сражаются за выход в оффлайн-финал.
                </p>

                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2 shrink-0" />
                    <span className="text-white/60 text-sm">Матчи каждый вечер в Discord-лобби</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2 shrink-0" />
                    <span className="text-white/60 text-sm">Формат: Best of 1 (до одной победы)</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2 shrink-0" />
                    <span className="text-white/60 text-sm">Расписание и сетка обновляются в Telegram-канале</span>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative bg-[#111] border border-red-500/10 rounded-2xl p-5 sm:p-8 h-full group-hover:border-red-500/20 transition-colors duration-300">
                {/* Stage number */}
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center">
                    <span className="text-red-400 font-orbitron font-bold text-base sm:text-lg">2</span>
                  </div>
                  <div>
                    <h3 className="font-orbitron font-bold text-base sm:text-xl text-white">Оффлайн-финал</h3>
                    <span className="text-red-400 text-xs tracking-widest uppercase">22 мая · ПК-клуб Барнаула</span>
                  </div>
                </div>

                <p className="text-white/50 mb-6 leading-relaxed">
                  Оффлайн-мероприятие состоится в <strong className="text-white/70">один день</strong> и будет включать только решающие матчи турнира.
                </p>

                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 shrink-0" />
                    <span className="text-white/60 text-sm">Начало: 12:00 (точное время уточним)</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 shrink-0" />
                    <span className="text-white/60 text-sm">Все матчи в формате <strong className="text-white/70">Best of 1</strong></span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 shrink-0" />
                    <span className="text-white/60 text-sm">Место: ПК-клуб Барнаула (адрес уточняется)</span>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            <div className="bg-[#111] border border-white/5 rounded-2xl p-4 sm:p-8 md:p-10">
              <h3 className="font-orbitron font-bold text-base sm:text-lg text-white mb-6 sm:mb-8 text-center">
                Схема проведения <span className="text-red-500">оффлайн-этапа</span>
              </h3>

              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                {/* Match 1 */}
                <div className="relative">
                  <div className="bg-[#0a0a0a] border border-white/5 rounded-xl p-5 text-center hover:border-red-500/30 hover:bg-red-500/5 transition-all duration-300">
                    <div className="text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Полуфинал 1</div>
                    <div className="flex flex-col gap-2">
                      <div className="bg-white/5 rounded-lg px-3 py-2 text-sm text-white/70 font-medium">Команда 1</div>
                      <div className="text-red-500 text-xs font-bold tracking-wider">VS</div>
                      <div className="bg-white/5 rounded-lg px-3 py-2 text-sm text-white/70 font-medium">Команда 4</div>
                    </div>
                    <div className="mt-3 text-[10px] text-white/25 tracking-wider">BO1</div>
                  </div>
                </div>
                ...
                <div className="relative">
                  <div className="bg-[#0a0a0a] border border-white/5 rounded-xl p-5 text-center hover:border-red-500/30 hover:bg-red-500/5 transition-all duration-300">
                    <div className="text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Полуфинал 2</div>
                    <div className="flex flex-col gap-2">
                      <div className="bg-white/5 rounded-lg px-3 py-2 text-sm text-white/70 font-medium">Команда 2</div>
                      <div className="text-red-500 text-xs font-bold tracking-wider">VS</div>
                      <div className="bg-white/5 rounded-lg px-3 py-2 text-sm text-white/70 font-medium">Команда 3</div>
                    </div>
                    <div className="mt-3 text-[10px] text-white/25 tracking-wider">BO1</div>
                  </div>
                </div>
                ...
                {/* Match 3 */}
                <div className="relative">
                  <div className="bg-[#0a0a0a] border border-yellow-500/10 rounded-xl p-5 text-center hover:border-yellow-500/30 hover:bg-yellow-500/5 transition-all duration-300">
                    <div className="text-[10px] tracking-[0.2em] uppercase text-yellow-400/50 mb-3">За 3-е место</div>
                    <div className="flex flex-col gap-2">
                      <div className="bg-white/5 rounded-lg px-3 py-2 text-sm text-white/70 font-medium">Проигравший 1</div>
                      <div className="text-yellow-400 text-xs font-bold tracking-wider">VS</div>
                      <div className="bg-white/5 rounded-lg px-3 py-2 text-sm text-white/70 font-medium">Проигравший 2</div>
                    </div>
                    <div className="mt-3 text-[10px] text-white/25 tracking-wider">BO1</div>
                  </div>
                </div>
                ...
                {/* Match 4 — Final */}
                <div className="relative">
                  <div className="absolute -inset-px bg-gradient-to-b from-red-500/20 to-transparent rounded-xl pointer-events-none" />
                  <div className="relative bg-[#0a0a0a] border border-red-500/20 rounded-xl p-5 text-center hover:border-red-500/40 transition-all duration-300">
                    <div className="text-[10px] tracking-[0.2em] uppercase text-red-400 mb-3">🏆 Гранд-финал</div>
                    <div className="flex flex-col gap-2">
                      <div className="bg-red-500/10 rounded-lg px-3 py-2 text-sm text-white/80 font-medium">Победитель 1</div>
                      <div className="text-red-500 text-xs font-bold tracking-wider">VS</div>
                      <div className="bg-red-500/10 rounded-lg px-3 py-2 text-sm text-white/80 font-medium">Победитель 2</div>
                    </div>
                    <div className="mt-3 text-[10px] text-red-400/50 tracking-wider">BO1 · Финал</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10 pt-8 border-t border-white/5">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                  <div className="py-3">
                    ...
                    <div className="text-sm font-bold text-white/80">1 место</div>
                    <div className="text-[10px] text-white/30 mt-1">Победитель финала</div>
                  </div>
                  <div className="py-3">
                    <div className="text-2xl mb-1">🥈</div>
                    <div className="text-sm font-bold text-white/60">2 место</div>
                    <div className="text-[10px] text-white/30 mt-1">Финалист</div>
                  </div>
                  <div className="py-3">
                    <div className="text-2xl mb-1">🥉</div>
                    <div className="text-sm font-bold text-white/50">3 место</div>
                    <div className="text-[10px] text-white/30 mt-1">Победитель матча за 3-е</div>
                  </div>
                  <div className="py-3">
                    <div className="text-2xl mb-1">4️⃣</div>
                    <div className="text-sm font-bold text-white/40">4 место</div>
                    <div className="text-[10px] text-white/30 mt-1">Проигравший за 3-е</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* ══════════ SCHEDULE ══════════ */}
      <Section id="schedule" className="relative py-16 sm:py-28 md:py-36 overflow-hidden">
        <div className="absolute inset-0 grid-bg opacity-20" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center gap-3 sm:gap-4 mb-4">
            <span className="text-red-500 font-orbitron font-bold text-sm">03</span>
            <div className="h-px w-8 sm:w-12 bg-red-500/40" />
            <span className="text-[10px] sm:text-[11px] tracking-[0.2em] sm:tracking-[0.3em] uppercase text-white/30">Расписание и результаты</span>
          </div>
          <h2 className="font-orbitron font-bold text-2xl sm:text-3xl md:text-5xl mb-4">
            Расписание <span className="text-red-500">матчей</span>
          </h2>
          <p className="text-white/40 text-base sm:text-lg mb-10 sm:mb-14 max-w-xl">
          ...
          <div className="mb-14">
            ...
            <div className="bg-gradient-to-br from-[#151515] to-[#0d0d0d] border border-white/5 rounded-2xl p-4 sm:p-6 md:p-8">
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="bg-white/[0.02] border border-white/5 rounded-xl p-3 sm:p-4 text-center">
                    <div className="text-white/50 text-xs sm:text-sm font-semibold mb-3">Полуфиналы</div>
                    <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 flex-wrap">
                      <div className="px-2 sm:px-3 py-1.5 sm:py-2 bg-red-500/10 border border-red-500/20 rounded-lg text-[11px] sm:text-xs font-bold text-red-400">Команда 1</div>
                      <span className="text-white/30 text-[10px] sm:text-xs">VS</span>
                      <div className="px-2 sm:px-3 py-1.5 sm:py-2 bg-red-500/10 border border-red-500/20 rounded-lg text-[11px] sm:text-xs font-bold text-red-400">Команда 2</div>
                    </div>
                    <div className="flex items-center justify-center gap-2 sm:gap-3 mb-4 flex-wrap">
                      <div className="px-2 sm:px-3 py-1.5 sm:py-2 bg-red-500/10 border border-red-500/20 rounded-lg text-[11px] sm:text-xs font-bold text-red-400">Команда 3</div>
                      <span className="text-white/30 text-[10px] sm:text-xs">VS</span>
                      <div className="px-2 sm:px-3 py-1.5 sm:py-2 bg-red-500/10 border border-red-500/20 rounded-lg text-[11px] sm:text-xs font-bold text-red-400">Команда 4</div>
                    </div>
      ...
      */}
      ...
      {/* ══════════ PRIZES ══════════ */}
      <Section id="prizes" className="relative py-16 sm:py-28 md:py-36 overflow-hidden">
        <div className="absolute inset-0 grid-bg opacity-20" />
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-center gap-3 sm:gap-4 mb-4">
            <span className="text-red-500 font-orbitron font-bold text-sm">04</span>
            <div className="h-px w-8 sm:w-12 bg-red-500/40" />
            <span className="text-[10px] sm:text-[11px] tracking-[0.2em] sm:tracking-[0.3em] uppercase text-white/30">Призы</span>
          </div>

          <h2 className="font-orbitron font-bold text-2xl sm:text-3xl md:text-5xl mb-4 text-center">
            Призовой <span className="text-red-500">фонд</span>
          </h2>
          <p className="text-white/40 text-base sm:text-lg mb-10 sm:mb-16 text-center max-w-lg mx-auto">
          ...
          <div className="flex justify-center mb-16">
            <div className="relative float">
              <img
                ...
                className="w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 object-cover rounded-full border-2 border-red-500/20 shadow-2xl shadow-red-500/10"
              />
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="font-orbitron text-2xl sm:text-3xl md:text-4xl font-black text-yellow-400 mb-2">12–15 тыс. ₽</div>
            ...
            >
              ...
              <div className="text-5xl mb-4">🥈</div>
              <div className="font-orbitron text-2xl sm:text-3xl md:text-4xl font-black text-gray-300 mb-2">7–8 тыс. ₽</div>
            ...
            >
              ...
              <div className="text-5xl mb-4">🥉</div>
              <div className="font-orbitron text-2xl sm:text-3xl md:text-4xl font-black text-orange-400 mb-2">2–3 тыс. ₽</div>
      ...
      {/* ══════════ REGISTRATION ══════════ */}
      <Section id="register" className="relative py-16 sm:py-28 md:py-36 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex justify-center mb-6">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 border border-red-500/30 rounded-full bg-red-500/5">
          ...
          <p className="text-white/40 text-base sm:text-lg mb-6 text-center max-w-xl mx-auto">
          ...
          >
            ...
            <div className="text-center pt-4">
              ...
              <p className="text-white/20 text-xs mt-4 max-w-md mx-auto">
                Заявка подтверждается в течение 24 часов. Нажимая кнопку, вы соглашаетесь с правилами турнира.
              </p>
            </div>
          </form>
        </div>
      ...
      <Section className="relative py-12 sm:py-20 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6">
          <h3 className="font-orbitron font-bold text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 text-center">
      ...
      {/* ══════════ CONTACTS ══════════ */}
      <Section id="contacts" className="relative py-16 sm:py-28 md:py-36 overflow-hidden">
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6">
          <div className="flex items-center gap-3 sm:gap-4 mb-4">
            <span className="text-red-500 font-orbitron font-bold text-sm">06</span>
            <div className="h-px w-8 sm:w-12 bg-red-500/40" />
            <span className="text-[10px] sm:text-[11px] tracking-[0.2em] sm:tracking-[0.3em] uppercase text-white/30">Контакты</span>
          </div>

          <h2 className="font-orbitron font-bold text-2xl sm:text-3xl md:text-5xl mb-8 sm:mb-14">
      ...
      <footer className="border-t border-white/5 py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 sm:gap-10 mb-8 sm:mb-10">
            ...
            <div>
              <h5 className="text-[10px] sm:text-[11px] tracking-[0.2em] uppercase text-white/30 mb-3 sm:mb-4">Навигация</h5>
              <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2 sm:gap-2">
                {NAV_LINKS.map((l) => (
                  <button
                    key={l.href}
                    onClick={() => scroll(l.href)}
                    className="text-left text-xs sm:text-sm text-white/40 hover:text-red-400 transition-colors"
                  >
                    {l.label}
                  </button>
                ))}
            ...
            <div>
              <h5 className="text-[10px] sm:text-[11px] tracking-[0.2em] uppercase text-white/30 mb-3 sm:mb-4">Следите за нами</h5>
              <div className="flex flex-wrap gap-2 sm:gap-3">
                {["Twitch", "Discord", "Telegram", "VK"].map((s) => (
                  <span
                    key={s}
                    className="px-2.5 py-1.5 sm:px-3 bg-white/5 border border-white/5 rounded-lg text-[11px] sm:text-xs text-white/40 hover:text-red-400 hover:border-red-500/20 transition-all cursor-pointer"
                  >
                    {s}
                  </span>
                ))}
          ...
          <div className="border-t border-white/5 pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4 text-center sm:text-left">
            <p className="text-white/20 text-[11px] sm:text-xs">© 2025 Первая Кровь. Все права защищены.</p>
            <p className="text-white/20 text-[11px] sm:text-xs">Dota 2 является зарегистрированной торговой маркой Valve Corporation.</p>
          </div>
        </div>
      </footer>
    </div>
